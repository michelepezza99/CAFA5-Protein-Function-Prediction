...
val_y_scoresk1_unweighted = unweighted_complex_KNN(X_train, Y_train, X_val, labels, 1, ancestor_dict, info_accretion)
val_y_scoresk1_unweighted.to_csv('val_y_scoresk1_unweighted_sum_normalization.csv', index=False)

val_y_scoresk2_unweighted = unweighted_complex_KNN(X_train, Y_train, X_val, labels, 2, ancestor_dict, info_accretion)
val_y_scoresk2_unweighted.to_csv('val_y_scoresk2_unweighted_sum_normalization.csv', index=False)

val_y_scoresk3_unweighted = unweighted_complex_KNN(X_train, Y_train, X_val, labels, 3, ancestor_dict, info_accretion)
val_y_scoresk3_unweighted.to_csv('val_y_scoresk3_unweighted_sum_normalization.csv', index=False)

val_y_scoresk5_unweighted = unweighted_complex_KNN(X_train, Y_train, X_val, labels, 5, ancestor_dict, info_accretion)
val_y_scoresk5_unweighted.to_csv('val_y_scoresk5_unweighted_sum_normalization.csv', index=False)

val_y_scoresk10_unweighted = unweighted_complex_KNN(X_train, Y_train, X_val, labels, 10, ancestor_dict, info_accretion)
val_y_scoresk10_unweighted.to_csv('val_y_scoresk10_unweighted_sum_normalization.csv', index=False)
