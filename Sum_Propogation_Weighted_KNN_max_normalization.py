...
val_y_scoresk1.to_csv('IC_val_y_scoresk1_weighted_max_normalization.csv', index=False)

val_y_scoresk2 = complex_KNN(X_train, Y_train, X_val, labels, 2, ancestor_dict, info_content)
val_y_scoresk2.to_csv('IC_val_y_scoresk2_weighted_max_normalization.csv', index=False)

val_y_scoresk3 = complex_KNN(X_train, Y_train, X_val, labels, 3, ancestor_dict, info_content)
val_y_scoresk3.to_csv('IC_val_y_scoresk3_weighted_max_normalization.csv', index=False)

val_y_scoresk5 = complex_KNN(X_train, Y_train, X_val, labels, 5, ancestor_dict, info_content)
val_y_scoresk5.to_csv('IC_val_y_scoresk5_weighted_max_normalization.csv', index=False)

val_y_scoresk10 = complex_KNN(X_train, Y_train, X_val, labels, 10, ancestor_dict, info_content)
val_y_scoresk10.to_csv('IC_val_y_scoresk10_weighted_max_normalization.csv', index=False)
